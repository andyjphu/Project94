...
while True:
    ...
    # Update the tools
    population["farmers"]["tools"] = population["artisans"]["count"] * population["artisans"]["production_efficiency"]
    ...
    if (food_surplus < 0):
        ...
        population["farmers"]["count"] = int(population["farmers"]["count"] * min(max(1.0, (population["farmers"]["food"] / population["farmers"]["count"])  - 0.25), 1.05))
        
        
        print(f"Food surplus is {food_surplus}, gained {population['farmers']['count'] - old_population} new farmers!")
    ...
    if ( population["farmers"]["count"] > population["farmers"]["tools"] and    (population["farmers"]["food"] / population["farmers"]["count"]) > 1.05):
        population["artisans"]["count"] += 1
        population["farmers"]["count"] -= 1
        print("Promoted a farmer to artisan")
